...
export default class Add_EA_Account extends Component {
    render() {
        return (
            <div>
                            ...
                            <div className="col-md-*">
                                <div className="box box-info">
                                    <div className="box-header with-border">
                                        <h3 className="box-title">Account EA Create</h3>
                                    </div>
                                    <form action="account_hsa_ea_edit.php" method="post" className="form-horizontal">
                                        ...
                                        <div className="box-body">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <div className="col-sm-8">
                                                    <input type="number" className="form-control" name="phone" id="phone" required="required" placeholder="09xxx44xxxx" />
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                <label htmlFor="inputPassword3" className="col-sm-2 control-label">Address</label>
                                                <div className="col-sm-8">
                                                    <input type="text" className="form-control" name="address" id="address" required="required" placeholder="au co" />
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                <label htmlFor="inputPassword3" className="col-sm-2 control-label">Branch</label>
                                                <div className="col-sm-8">
                                                    <input type="text" className="form-control" name="branch" id="branch" placeholder="...................." />
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                <label htmlFor="inputPassword3" className="col-sm-2 control-label">Edge</label>
                                                <div className="col-sm-8">
                                                    <select name="edge" id="edge" className="form-control select2" style={{ width: '100%' }}>
